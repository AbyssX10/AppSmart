    ...
    <div class="content-header">
        ...
        <div class="header-inputs">
            <div class="inputs">
                ...
                <input type="submit" value="Export to Excel" onclick="tableToExcel('table-providers', 'Empleados')">
            </div>
            <div class="inputs">
                <div class="child">
        ...
        <div class="header-inputs-mobile">
            <div class="inputs">
                <div class="child">
                    <button onclick="tableToExcel('table-providers', 'Empleados')">
                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-file-earmark-arrow-down-fill" viewBox="0 0 16 16">
                            <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0zM9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1zm-1 4v3.793l1.146-1.147a.5.5 0 0 1 .708.708l-2 2a.5.5 0 0 1-.708 0l-2-2a.5.5 0 0 1 .708-.708L7.5 11.293V7.5a.5.5 0 0 1 1 0z"/>
                        </svg>
                    </button>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="inputs-actions">
                                ...
                                <div class="right">
                                    <button id="Delete" onclick="<?php echo "ConfirmProvider('".$item["nombreProveedor"]."', '".$item["nombreContacto"]."')"; ?>">
