    ...
    <div class="content-header" style="height: 15%;">
        ...
        <div class="header-inputs">
            <div class="inputs">
                ...
                <input type="submit" value="Export to Excel" onclick="tableToExcel('table-products', 'Productos')">
            </div>
            <div class="inputs">
                <div class="child">
        ...
        <table id="table-products">
            ...
            <tbody>
                <?php
                    ...
                    foreach($config->GetAllProducts() as $item){
                
                ?>

                <tr>
                    <td><?php echo $item["idProducto"]; ?></td>
                    <td><img style="width: 30px; height: auto;" src="<?php echo $item["fotoProducto"]; ?>" alt=""></td>
                    <td><?php echo $item["nombreProducto"]; ?></td>
                    <td><?php echo $item["cantidadProducto"]; ?></td>
                    <td><?php echo $item["precioUnitario"]; ?></td>
                    <td><?php echo $item["referenciaProducto"]; ?></td>
                    <td>
                        <div class="inputs-actions">
                            ...
                            <div class="right">
                                <button id="Delete" onclick="<?php echo "ConfirmProdu('".$item["nombreProducto"]."', '".$item["referenciaProducto"]."')"; ?>">
