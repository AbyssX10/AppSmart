                    ...
                    <tr style="<?php if($_SESSION["user"]["nombrePerson"] == $item["nombrePerson"]) echo "cursor: not-allowed; background-color: #DADADA; color: #616161;" ?>">
                        ...
                        <td>
                            <div class="inputs-actions">
                                <div class="left">
                                    <button onclick="<?php if($_SESSION["user"]["nombrePerson"] == $item["nombrePerson"]) { echo "event.cancelBubble = true;"; } else { echo "EditsUser('".$item["dniPerson"]."','".$item["nombrePerson"]."','".$item["telefonoPerson"]."','".$item["direccionPerson"]."')"; } ?>" style="<?php if($_SESSION["user"]["nombrePerson"] == $item["nombrePerson"]) echo "cursor: not-allowed;" ?>">
